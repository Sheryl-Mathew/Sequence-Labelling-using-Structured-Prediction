...
plot_learning_curve(losses_1, losses_2, losses_3, losses_4, iterations, "OCR RGS Inference Training", "lcRgsTraining1")
plot_accuracy_curve(accuracies_1, accuracies_2, accuracies_3, accuracies_4, iterations, "OCR RGS Inference Training", "acRgsTraining1")
...
iterations = [x+1 for x in list(range(max_iterations))]
plot_learning_curve(losses_1, losses_2, losses_3, losses_4, iterations, "OCR RGS Inference Testing", "lcRgsTesting1")
plot_accuracy_curve(accuracies_1, accuracies_2, accuracies_3, accuracies_4, iterations, "OCR RGS Inference Testing", "acRgsTesting1")
