...
plot_learning_curve(losses_1, losses_2, losses_3, losses_4, iterations, "Text to Speech RGS Inference Training", "lcRgsTraining4")
plot_accuracy_curve(accuracies_1, accuracies_2, accuracies_3, accuracies_4, iterations, "Text to Speech RGS Inference Training", "acRgsTraining4")
...
iterations = [x+1 for x in list(range(max_iterations))]
plot_learning_curve(losses_1, losses_2, losses_3, losses_4, iterations, "Text to Speech RGS Inference Testing", "lcRgsTesting4")
plot_accuracy_curve(accuracies_1, accuracies_2, accuracies_3, accuracies_4, iterations, "Text to Speech RGS Inference Testing", "acRgsTesting4")
