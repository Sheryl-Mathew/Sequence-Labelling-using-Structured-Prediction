...
def rgsTestingAlgorithm(w, n, x, y, max_iterations, repeats, learning_rate, number_of_possible_labels, possible_labels):
    losses = []
    accuracies = []
    y_pred = []
    y_true = []
...
plot_learning_curve(losses_1, losses_2, losses_3, losses_4, iterations, "Text to Speech RGS Inference Training", "lcRgsTraining3")
plot_accuracy_curve(accuracies_1, accuracies_2, accuracies_3, accuracies_4, iterations, "Text to Speech RGS Inference Training", "acRgsTraining3")


# In[35]:


losses_1,accuracies_1, mistakes_1 = rgsTestingAlgorithm(w_1, 1, x_test, y_test, max_iterations, repeats, learning_rate, number_of_possible_labels, possible_labels)
losses_2,accuracies_2, mistakes_2 = rgsTestingAlgorithm(w_2, 2, x_test, y_test, max_iterations, repeats, learning_rate, number_of_possible_labels, possible_labels)
losses_3,accuracies_3, mistakes_3 = rgsTestingAlgorithm(w_3, 3, x_test, y_test, max_iterations, repeats, learning_rate, number_of_possible_labels, possible_labels)
losses_4,accuracies_4, mistakes_4 = rgsTestingAlgorithm(w_4, 4, x_test, y_test, max_iterations, repeats, learning_rate, number_of_possible_labels, possible_labels)
...
iterations = [x+1 for x in list(range(max_iterations))]
plot_learning_curve(losses_1, losses_2, losses_3, losses_4, iterations, "Text to Speech RGS Inference Testing", "lcRgsTesting3")
plot_accuracy_curve(accuracies_1, accuracies_2, accuracies_3, accuracies_4, iterations, "Text to Speech RGS Inference Testing", "acRgsTraining3")
