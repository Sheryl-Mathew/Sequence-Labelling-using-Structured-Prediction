...
iterations = [x+1 for x in list([5, 10, 15, 20])]
plot_learning_curve([], losses_2,  [], [], iterations, "Text to Speech RGS Inference Training", "lcRgsTrainingRepeat")
plot_accuracy_curve( [], accuracies_2, [], [], iterations, "Text to Speech RGS Inference Training", "acRgsTrainingRepeat")
...
iterations = [x+1 for x in list([5, 10, 15, 20])]
plot_learning_curve([], losses_2, [], [], iterations, "Text to Speech RGS Inference Testing", "lcRgsTestingRepeat")
plot_accuracy_curve([], accuracies_2, [], [], iterations, "Text to Speech RGS Inference Testing", "acRgsTestingRepeat")
