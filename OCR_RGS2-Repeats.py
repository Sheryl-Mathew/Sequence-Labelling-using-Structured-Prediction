...
x_train = x_train[0:50].copy()
y_train = y_train[0:50].copy()
...
plot_learning_curve([], losses_2, [], [], iterations, "OCR RGS Inference Training", "lcRgsTrainingRepeats")
plot_accuracy_curve([], accuracies_2, [], [], iterations, "OCR RGS Inference Training", "acRgsTrainingRepeats")
...
iterations = [x+1 for x in list([5, 10, 15, 20])]
plot_learning_curve([], losses_2, [], [], iterations, "OCR RGS Inference Testing", "lcRgsTestingRepeats")
plot_accuracy_curve([], accuracies_2, [], [], iterations, "OCR RGS Inference Testing", "acRgsTestingRepeats")
